...
$table_descriptions = array(
    'content_auto_api_configs' => array(
        ...
        'fields' => array(
            ...
            'vector_api_type' => __('向量API类型（openai/jina）', 'content-auto-manager'),
            'stream' => __('是否启用流式输出', 'content-auto-manager'),
            'top_p' => __('核采样参数', 'content-auto-manager'),
            'stream_enabled' => __('是否启用stream参数控制', 'content-auto-manager'),
            'top_p_enabled' => __('是否启用top_p参数控制', 'content-auto-manager'),
    ...
    'content_auto_brand_profiles' => array(
        ...
        'fields' => array(
            ...
            'title' => __('品牌/产品名称', 'content-auto-manager'),
            'type' => __('物料类型：standard标准样式，custom_html自定义HTML，reference参考资料', 'content-auto-manager'),
            'image_url' => __('图片URL', 'content-auto-manager'),
            'description' => __('描述信息', 'content-auto-manager'),
            'link' => __('相关链接', 'content-auto-manager'),
            'custom_html' => __('自定义HTML代码', 'content-auto-manager'),
            'vector' => __('向量数据（JSON格式）', 'content-auto-manager'),
            'created_at' => __('创建时间', 'content-auto-manager'),
            'updated_at' => __('更新时间', 'content-auto-manager')
        )
    ),
    ...
    'content_auto_topics' => array(
        ...
        'fields' => array(
            ...
            'material_search_status' => __('素材搜索状态（none/waiting_for_extension/completed/failed）', 'content-auto-manager'),
            'material_search_error' => __('自动素材搜索错误信息', 'content-auto-manager'),
            'created_at' => __('创建时间', 'content-auto-manager'),
            'updated_at' => __('更新时间', 'content-auto-manager')
        )
    ),
    'content_auto_article_tasks' => array(
        ...
        'fields' => array(
            ...
            'current_processing_item' => __('当前处理的子任务数量', 'content-auto-manager'),
            'total_rule_items' => __('总子任务数量', 'content-auto-manager'),
            'generated_articles_count' => __('已生成文章数量', 'content-auto-manager'),
            'last_processed_at' => __('最后处理时间', 'content-auto-manager'),
            'created_at' => __('创建时间', 'content-auto-manager'),
            'updated_at' => __('更新时间', 'content-auto-manager')
        )
    ...
    'content_auto_publish_rules' => array(
        ...
        'fields' => array(
            ...
            'enable_auto_material_search' => __('是否启用自动素材搜索（0关闭、1启用，兼容旧版本）', 'content-auto-manager'),
            'material_collection_mode' => __('素材收集模式（none关闭、search_engine网络搜索、extension_rag知识库搜索）', 'content-auto-manager'),
            'enable_intent_inference' => __('是否启用搜索意图推断（0关闭、1启用）', 'content-auto-manager'),
            'publish_language' => __('发布语言代码（如zh-CN、en-US等），影响内容生成的输出语言', 'content-auto-manager'),
            'role_description' => __('AI角色描述，用于文章生成的提示词模板', 'content-auto-manager'),
            'image_prompt_template' => __('图片生成提示词模板，用于指导AI生成图片占位符', 'content-auto-manager'),
            'created_at' => __('创建时间', 'content-auto-manager'),
            'updated_at' => __('更新时间', 'content-auto-manager')
        )
    ),
    ...
    'content_auto_prompt_templates' => array(
        'name' => __('提示词模板表', 'content-auto-manager'),
        'description' => __('存储内容生成所使用的提示词模板，支持文章生成和主题生成等多种类型', 'content-auto-manager'),
        'fields' => array(
            'id' => __('模板唯一标识符', 'content-auto-manager'),
            'name' => __('模板名称', 'content-auto-manager'),
            'template_type' => __('模板类型（topic_generation、article_generation）', 'content-auto-manager'),
            'content' => __('模板内容（XML格式）', 'content-auto-manager'),
            'source_file' => __('源文件名，用于防止重复导入和版本追踪', 'content-auto-manager'),
            'is_active' => __('是否激活（1启用，0禁用）', 'content-auto-manager'),
            'created_at' => __('创建时间', 'content-auto-manager'),
            'updated_at' => __('更新时间', 'content-auto-manager')
        )
    )
