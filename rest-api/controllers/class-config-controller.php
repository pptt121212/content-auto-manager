...
class Config_Controller extends Base_Controller {
    ...
    public function get_config( $request ) {
        if ( ! class_exists( 'ContentAuto_ApiConfig' ) ) {
            if ( file_exists( WP_PLUGIN_DIR . '/content-auto-manager/api-settings/class-api-config.php' ) ) {
                 require_once WP_PLUGIN_DIR . '/content-auto-manager/api-settings/class-api-config.php';
            }
        }
