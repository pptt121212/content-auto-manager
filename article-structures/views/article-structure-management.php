<div class="wrap" id="article-structures-page">
    ...
    <nav class="nav-tab-wrapper">
        <a href="admin.php?page=content-auto-manager-article-structures" class="nav-tab nav-tab-active">结构管理</a>
        <a href="admin.php?page=content-auto-manager-smart-optimization" class="nav-tab">智能优化</a>
    </nav>
