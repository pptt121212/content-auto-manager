...
function content_auto_editor_assistant_enqueue_block_editor_assets() {
    $script_path = CONTENT_AUTO_MANAGER_PLUGIN_DIR . 'editor-assistant/gutenberg/index.js';
    $asset_path  = CONTENT_AUTO_MANAGER_PLUGIN_DIR . 'editor-assistant/gutenberg/index.asset.php';
    $css_path    = CONTENT_AUTO_MANAGER_PLUGIN_DIR . 'editor-assistant/gutenberg/index.css';
    ...
    $script_url = CONTENT_AUTO_MANAGER_PLUGIN_URL . 'editor-assistant/gutenberg/index.js';
    $style_url  = CONTENT_AUTO_MANAGER_PLUGIN_URL . 'editor-assistant/gutenberg/index.css';
    ...
    if (!class_exists('ContentAuto_Editor_Prompt_Manager')) {
        if (defined('CONTENT_AUTO_MANAGER_PLUGIN_DIR') && file_exists(CONTENT_AUTO_MANAGER_PLUGIN_DIR . 'editor-assistant/class-prompt-manager.php')) {
            require_once CONTENT_AUTO_MANAGER_PLUGIN_DIR . 'editor-assistant/class-prompt-manager.php';
        }
    }

    $prompts = class_exists('ContentAuto_Editor_Prompt_Manager')
        ? ContentAuto_Editor_Prompt_Manager::get_prompts()
        : array();
    ...
    wp_set_script_translations(
        'content-auto-editor-assistant-block',
        'yali-ai-writer',
        CONTENT_AUTO_MANAGER_PLUGIN_DIR . 'languages'
    );
...
add_action('enqueue_block_editor_assets', 'content_auto_editor_assistant_enqueue_block_editor_assets');